        ...
        <div>
            ...
            <div class="py-16 text-center">
                <section id="Galleries" class="">
                    ...
                    <p class="pt-8">Collections of the rest of my photography work.</p>
                    <section>
                        <div id="Bristol09-01">
                            <a href='/bristol/'><h3 class="gallery-link text-2xl underline pt-16">Bristol 09/01/2025</h3></a>
                            <p class="pt-8">Day trip to Bristol in January 2025.</p>
                            <div class="grid grid-cols-2 gap-4 m-auto justify-items-center pt-16">
